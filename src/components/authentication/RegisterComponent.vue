               ...
               <div class="row  mt-5">
                  ...
                  <div class="col-xl-4 col-md-6 pe-0">
                     <div class="sign-in-your">
                           ...
                           <div class="row d-flex justify-content-between mt-4 mb-2">
                              <div class="mb-3">
                                 <div class="form-check custom-checkbox ms-1">
                                    ...
                                    <label class="form-check-label" htmlFor="basic_checkbox_1">Agree to Terms & Conditions</label>
                                 </div>
                              </div>
                        ...
                        <div class="text-center">
                           <span>Already have an account?<a href="/" class="text-primary"> Sign Up</a></span>
                        </div>
                     </div>
                  </div>
               </div>
